# -*- coding: utf-8 -*-
# Pulled from Open3D
# SimplifyLine documentation build configuration file, created by
...
# Import simplifyline raw python package with the highest priority
# This is a trick to show simplifyline.simplifyline as simplifyline in the docs
...
breathe_projects = {
    "SimplifyLine_CPP": "./_out/xml"
}

breathe_default_project = "SimplifyLine_CPP"
...
htmlhelp_basename = 'SimplifyLinedoc'
...
man_pages = [(master_doc, 'simplifyline', u'SimplifyLine Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'simplifyline', u'SimplifyLine Documentation', author, 'SimplifyLine',
